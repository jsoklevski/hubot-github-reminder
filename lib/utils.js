...
internals.getUsers = function(robot_brain) {
  if (robot_brain.adapter && robot_brain.adapter.client
    && robot_brain.adapter.client.rtm
    && robot_brain.adapter.client.rtm.dataStore ) {
...
exports.formatPullRequest = function(fetched_pull_request, repoName, statusChecks) {
  var assignees_list = [];
...
exports.findUser = function(robot_brain, hubot_username) {
  var f, results, users;
  users = internals.getUsers(robot_brain);
...
exports.lookupUserWithGithub = function(robot_brain, github_username){
  ...
  if (hubotUser) {
    return _this.findUser(robot_brain, hubotUser);
  }
  else {
    return _this.findUser(robot_brain, github_username);
  }
};
